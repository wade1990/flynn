// Copied from https://raw.githubusercontent.com/jansel369/grommet-typescript/master/grommet/index.d.ts
...
declare module 'grommet/components/icons/Spinning' {
	export default Grommet.Spinning;
}
...
declare module 'grommet' {
	...
	export import Spinning = Grommet.Spinning;
...
declare namespace Grommet {
	...
	export interface BoxProps<S = BoxSizeProp> {
	...
	interface FooterProps extends BoxProps<FooterSize> {
		fixed?: boolean;
		float?: boolean;
		primary?: boolean;
	}
	...
	interface HeaderProps extends BoxProps<HeaderSize> {
		fixed?: boolean;
		float?: boolean;
		splash?: boolean;
	}
	...
	export class ListItem extends React.Component<BoxProps> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
	...
	interface MenuProps extends BoxProps<GrommetBoxTypes.PadSizes> {
	...
	interface NotificationProps extends BoxProps<NotificationSize> {
		closer?: React.ReactNode | boolean;
	...
	type QuoteSize = 'small' | 'medium' | 'large' | 'full';
	interface QuoteProps extends BoxProps<QuoteSize> {
	...
	type SidebarSize = 'xsmall' | 'small' | 'medium' | 'large';
	interface SidebarProps extends BoxProps<SidebarSize> {
		fixed?: boolean;
		full?: boolean;
	}
	...
	export class SkipLinkAnchor extends React.Component<SkipLinkAnchorProps> {}

	export class SkipLinks extends React.Component<any> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
	...
	export class Spinning extends React.Component<SpinningProps> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
	...
	export class SunBurst extends React.Component<SunBurstProps> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
	...
	export class Tiles extends React.Component<TilesProps> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
	...
	export class Topology extends React.Component<TopologyProps> {
		context: GrommetContextTypes.Intl;
		render(): JSX.Element;
	}
